...
let bodyall = document.getElementById("bodyall");
let activation = "Activer le mode sombre";
function toggleDarkMode() {
    bodyall.classList.toggle("dark-mode");
    if (bodyall.classList.contains("dark-mode")){
        activation = "Désactiver le mode sombre";
    }
    else{
        activation = "Activer le mode sombre";
    }
    buttondarkmode.textContent = activation;
}
